...
import logo from 'figma:asset/8e8fffae8b9b669353d85c5d9a15573546fdd950.png';
        ...
        <div className="bg-card border border-cyan-500/20 rounded-3xl p-8 shadow-[0_0_50px_rgba(6,182,212,0.1)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 bg-background border border-border rounded-lg text-foreground placeholder-muted-foreground focus:outline-none focus:border-cyan-500/50 transition-all"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 bg-background border border-border rounded text-cyan-500 focus:ring-cyan-500 focus:ring-offset-0"
                />
                <span className="text-sm text-card-foreground">Remember me</span>
              </label>
              <Link to="#" className="text-sm text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 transition-colors">
                Forgot password?
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                type="button"
                className="px-4 py-3 bg-background border border-border rounded-lg text-foreground hover:border-cyan-500/50 transition-all flex items-center justify-center space-x-2"
              >
          ...
          <p className="mt-8 text-center text-muted-foreground">
            ...
            <Link to="/signup" className="text-cyan-600 dark:text-cyan-400 hover:text-cyan-500 font-medium transition-colors">
              Sign up for free
            </Link>
          </p>
        </div>
